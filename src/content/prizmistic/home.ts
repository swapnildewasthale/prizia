export const home = {
  ...
  values: [
    {
      title: "Learn",
      description: "Sirf information collect karna nahi — samajhna, ghera jaana, khud ko challenge karna.",
      icon: "learn",
    },
    {
      title: "Make",
      description: "Jo seekha hai, uske saath kuch banao. Haath ganda karo. Create karo.",
      icon: "make",
    },
    {
      title: "Experiment",
      description: "Try karo. Galat ho. Dobara try karo. Har idea ek experiment ho sakta hai.",
      icon: "experiment",
    },
    {
      title: "Explore",
      description: "Dekho idea tumhe kahan le jaata hai. Curiosity ko follow karo.",
      icon: "explore",
    },
  ],
